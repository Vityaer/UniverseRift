...
namespace Common
{
    public class GameController : MonoBehaviour
    {
        ...
        {
            Instance.AddResource(reward.GetListResource);
        ...
        public static Models.PlayerModel GetPlayerSave { get => instance.player.PlayerGame.playerSaveObject; }
        public static GameModel GetPlayerGame { get => instance.player.PlayerGame; }
